			...
			<div className="container mx-auto px-4 py-8">
				...
				<section className="grid lg:grid-cols-2 gap-16 items-center mb-20">
					...
					<div className="relative">
						<div className="bg-gradient-to-br from-pink-400 to-pink-500 rounded-lg p-8 min-h-[400px] flex items-center justify-center">
							<Image
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						{team.map((member, index) => (
							<div key={index} className="text-center">
								<div className="bg-gray-100 rounded-lg p-8 mb-4 min-h-[400px] flex items-end justify-center">
									<Image
