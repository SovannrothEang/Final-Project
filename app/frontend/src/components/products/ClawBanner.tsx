...
export function ClawBanner() {
	return (
		<section className="relative w-full h-[180px] sm:h-[250px] lg:h-[300px] rounded-xl overflow-hidden mb-16">
			{/* Background image */}
			<Image
				src="/Claw.png"
			...
			<div className="absolute inset-0  flex flex-col justify-center  text-white px-4">
				...
				<Button className="bg-white text-black hover:bg-gray-100 w-[100px] ">Shop Now</Button>
			</div>
		</section>
	);
}
